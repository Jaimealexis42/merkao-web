...
**Funshine** — música de fondo del Reel, upbeat/sunny vibe.

- Fuente: <https://github.com/SoundSafari/CC0-1.0-Music> → `freepd.com/Funshine.mp3`
- Licencia: **CC0 1.0 (dominio público)** — sin attribution requerida
- Duración: 2:45 (loop con `-stream_loop -1` en ffmpeg, recortado a 15s)
